  ...
  properties: {
    ...
    vehicle: {
      ...
      properties: {
        ...
        end_date: { type: 'string', format: 'date-time', example: '2024-02-27T18:30:00.000Z' },
      },
...
// Exporting the updateRoute and updateUserBody objects for use in other modules.
export { updateRoute, updateUserBody };
