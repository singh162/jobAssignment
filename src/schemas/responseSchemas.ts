...
const GetOneResponse = {
  ...
  properties: {
    ...
    start_date: { type: 'string', format: 'date-time', example: '2024-02-27 00:33:33' },
    ownership_end_date: { type: 'string', format: 'date-time', example: '2024-02-27 00:33:33' },
    maintenance_type: { type: 'string', example: 'Oil Change' },
    maintenance_date: { type: 'string', format: 'date-time', example: '2024-02-27 00:33:33' },
...
// Exporting all response schemas for use in other modules.
export {
  createResponse,
  ApiResponse,
  VehicleResponse,
